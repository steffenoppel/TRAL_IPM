...
cat("
    ...
    Ntot.breed[1] ~ dunif(1000,2000) #1638   ### sum of counts is 2400, but we take average over 3 years because 2001 was an outlier year
...
# RUN THE FOUR SCENARIOS {took 6 hours for niter=50000)
TRALipm <- jags(jags.data, inits, parameters, "C:\\STEFFEN\\RSPB\\UKOT\\Gough\\ANALYSIS\\PopulationModel\\TRAL_IPM\\TRAL_IPM_fut_v4.jags", n.chains = nc, n.thin = nt, n.iter = ni, n.burnin = nb,parallel=T)
#TRALmouse <- jags(jags.data, inits, parameters, "C:\\STEFFEN\\RSPB\\UKOT\\Gough\\ANALYSIS\\PopulationModel\\TRAL_IPM\\TRAL_IPM_fut_v2_mouse.jags", n.chains = nc, n.thin = nt, n.iter = ni, n.burnin = nb,parallel=T)
...
#########################################################################
setwd("C:\\STEFFEN\\RSPB\\UKOT\\Gough\\ANALYSIS\\PopulationModel\\TRAL_IPM")
save.image("TRAL_IPM_output_v3_fixed_juv_surv.RData")
